		...
		<header>
			...
			<div class="header-wrapper d-flex jc-between mb-32 ai-center text-primary-100 fw-500 fs-20">
				...
				<div class="search-wrapper d-block d-md-none">
					<a href="#"><img class="bg-primary pi-20 pb-16 radius-12" src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-1.png' ?>" alt="search"></a>
				</div>

				<div class="menu-icon-wrapper d-none d-md-block" id="mobileMenuOpener">
					<a href="#"><img class="bg-primary pi-20 pb-16 radius-12" src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-5.png' ?>" alt="search"></a>
				</div>
			</div>
