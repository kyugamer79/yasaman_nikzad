(() => {
  ...
  var mobileMenu = () => {
    ...
    mobileMenu2.addEventListener("click", (event2) => {
      if (event2.target === mobileMenu2) {
  ...
  var singleServiceSwiper = new Swiper("#singleServiceSwiper", {
  ...
  var consentSwiper = new Swiper("#consentSwiper", {
    modules: [Navigation, Pagination],
    loop: true,
    slidesPerView: 2,
    pagination: {
