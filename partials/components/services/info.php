...
<div class="info-cards-wrapper">
    <div class="info-card box-col-3 gap-116 ">
        ...
        <div
            class="time-section-<?php echo $i ?>-wrapper | col-span-1 col-span-md-3 col-span-lg-3 d-lg-flex d-none jc-center ai-center gap-4">
            <div class="time-section-<?php echo $i ?> fs-h1 text-natural-100"><?php echo get_field($item['acf_key']) ?>
            </div>
